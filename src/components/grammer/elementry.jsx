...
export default function Elementry() {
  return (
    <div>
        <h1 className='text-center text-white text-[25px] font-bold py-[10px] my-5 bg-[#1a8ec1]'>A1 GRAMMAR LESSONS AND EXERCISES
</h1>
        <div className='container'>
            <div className='card-wrapper flex justify-around items-center flex-wrap gap-y-5 pb-[20px]'>
                ...
                <LessonCards img={e23} text={'A, some, any – countable and uncountable nouns'} path={''} />
                <LessonCards img={e24} text={'There is, there are – there was, there were'} path={''} />
                <LessonCards img={e25} text={'There or it'} path={''} />
                ...
                <LessonCards img={e28} text={'Comparative adjectives – older than, more important than, etc.'} path={''} />
                <LessonCards img={e29} text={'Superlative adjectives – the oldest, the most important, etc.'} path={''} />
                <LessonCards img={e30} text={"'Will' and 'shall' – Future"} path={''} />
                <LessonCards img={e31} text={'Be going to – plans and predictions'} path={''} />
                <LessonCards img={e32} text={'Adverbs of manner (slowly) – or adjectives (slow)?'} path={''} />
                ...
                <LessonCards img={e35} text={'Basic word order in English'} path={''} />
