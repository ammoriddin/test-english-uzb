        ...
        <div>
            ...
            <div className='container'>
                <div className='card-wrapper flex justify-start gap-x-[22px] items-center flex-wrap gap-y-5 pb-[20px]'>
                    <LessonCards img={writing1} text={'A1 Writing mashqlar va Testlar'} path={'writing/a1'}/>
                    <LessonCards img={writing2} text={'A2 Writing mashqlar va Testlar'} path={'writing/a2'}/>
                    <LessonCards img={writing3} text={'B1 Writing mashqlar va Testlar'} path={'writing/b1'}/>
                    <LessonCards img={writing4} text={'B1+ Writing mashqlar va Testlar'} path={'writing/b1+'}/>
                    <LessonCards img={writing5} text={'B2 Writing mashqlar va Testlar'} path={'writing/b2'}/>
                </div>
            </div>
        </div>
    </>
